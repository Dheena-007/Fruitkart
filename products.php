            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rapple.jpg" alt="rapple">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red Apples</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rawmangos.jpg" alt="rawmangos">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Raw Mangos</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/greenapples.jpg" alt="greenapples">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Green Apples</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/greengrapes.jpg" alt="greengrapes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>greengrapes</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/blackgrapes.jpg" alt="blackgrapes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Grape</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sapota.jpg" alt="sapota">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>sapota</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/avacado.jpg" alt="avacado">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Avacado</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/periyanellikai.jpg" alt="Periyanellikai">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>periyanellikai</h3>
                                    <p>Price: Rs. 120.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
